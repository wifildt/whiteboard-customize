...
const Whiteboard = ({
  ...
  const handleBackInitialPosition = () => {
    board.canvas.setViewportTransform([zoom, 0, 0, zoom, 0, 0]);
  }
    ...
    <WhiteBoardS ref={whiteboardRef}>
      <ToolbarHolderS>
        ...
        <ToolbarS>
          ...
          <SeparatorS />
          <ToolbarItemS>
            <ButtonS onClick={handleBackInitialPosition} title='Move to initial location'>
              <img src={RefreshIcon} alt="Delete" />
            </ButtonS>
          </ToolbarItemS>
